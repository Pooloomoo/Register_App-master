  ...
  return (
    <div className="container ">
      <div className='d-flex w-100 vh-100 justify-content-center align-items-center'>
        <div className='w-50 border bg-dark text-white p-5 vh-100'>
          <form onSubmit={handleSubmit}>
            <div>
              <h2 className='text-warning'>{`EDIT UserProject ID: ${userProject.id}`}</h2>
            ...
            <button id="cancel-btn" className="btn btn-warning m-auto" onClick={handleCancel}>Cancel</button>
          </form>
        </div>
      </div>
    </div>
